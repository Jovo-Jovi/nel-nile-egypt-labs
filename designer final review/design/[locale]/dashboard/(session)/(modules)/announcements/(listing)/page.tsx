...
import { listAnnouncementRows } from "@/lib/dashboard/catalogEntities";
    ...
    <>
      ...
      <div className={extra.groups}>
        <CatalogRowList
          ...
          editPrefix="/dashboard/announcements"
        />
        <AnnouncementForm locale={locale} row={null} notice={notice} assets={assets} />
      </div>
    </>
  );
}
