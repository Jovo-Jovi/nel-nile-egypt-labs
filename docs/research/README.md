...
| `g8r2-evidence.md` | The G8-R2 gate re-run (P08-T29), 14 September 2026. P10 restatement from P08-T20 is retained and still in force. Precedence none — evidence, not a verdict. The reviewer issues G8. | 14 Sep 2026 |
| `g4-evidence.md` | Computed facts from production at P04-T03. Not a model document, not a G4 verdict. The reviewer issues G4. | 15 Sep 2026 |
| `g10-evidence.md` | Computed facts from production at P10-T04. Not a model document, not a G10 verdict. The reviewer issues G10. | 15 Sep 2026 |
