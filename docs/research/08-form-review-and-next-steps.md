...
| Portal has no support contract | Nobody is contractually obliged to renew that certificate on 28 October |

That last row deserves its own sentence in the quotation. **The results portal certificate expires 28 October 2026, inside your project window.** The person who maintains it is your project contact and there is no support contract. If it lapses in the same week you launch, your new site will be blamed. Put the reminder in writing, dated, and keep the reply.
